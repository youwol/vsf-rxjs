 ...
 * where the inner observables are provided using a {@link VsfCore.Projects.MacroModel}
 * from the {@link VsfCore.Projects.ProjectState | Project}.
 *
 ...
 *
 * The {@link MergeMap} version of the module (inner observable provided as plain javascript function) is
 * also available.
 *
 ...
 * @module
 */
import { Immutable, Modules, Projects } from '@youwol/vsf-core'
...
export const outputs = (
    ...
    return {
        output$: arg.inputs.input$.pipe(
            ...
            mergeMap((message) => innerObservable(arg.state, message)),
        ),
